...
export const ProjectItem: React.FC<ProjectItemProps> = ({ project }) => {
    ...
    return (
        ...
        //         <p className="text-tiny uppercase font-bold"> Created by {project.createdBy.firstName} {project.createdBy.lastName} </p>
        //     </CardHeader>
        //     <CardBody className="overflow-visible py-2">
        //         <Image
        //             alt="Card background"
        //             className="object-cover rounded-xl"
        //             src="https://www.projectmanagement.ie/wp-content/uploads/2022/02/project-manager-illustration.jpg"
        //             width={270}
        //         />
        //     </CardBody>
        // </Card>
        ...
        >
            ...
            <CardFooter className="justify-between before:bg-white/10 border-white/20 border-1 overflow-hidden py-2 absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10">
                ...
                <Button className="text-tiny text-white bg-black" variant="flat" color="default" radius="lg" size="md">
                    Open project
                </Button>
            </CardFooter>
        </Card>
